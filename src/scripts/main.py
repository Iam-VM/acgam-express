...
if __name__ == '__main__':
    ...
    try:
        ...
        # event_names = recipient_df['event_name'].to_list()
    ...
    try:
        cert = Cert(template_type, recipient_type, event_name)
        ...
        if isinstance(recipient_emails, list) and isinstance(recipient_names, list) and isinstance(college_names, list):
            ...
            for recipient_name, recipient_email in zip(recipient_names, recipient_emails):
                cert_path = cert.create(recipient_name, college_names[index], dir_name, event_id, recipient_email)
